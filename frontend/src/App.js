...
import AdminStatistics from "./Components/core/Dashboard/AdminStatistics";
import Assignment from "./Components/core/Dashboard/Assignment";
import SubmitAssignment from "./Components/core/Dashboard/SubmitAssignment";
import FeedbackForm from "./Components/core/Dashboard/Feedback";
import FeedbackList from "./Components/core/Dashboard/FetchFeedback";
import CourseStudentList from "./Components/core/Dashboard/ShowGrade";
import CourseWiseGrades from "./Components/core/Dashboard/ShowGrade";
        ...
        >
          ...
          {user?.accountType === ACCOUNT_TYPE.STUDENT && (
            <>
              ...
              />
              <Route path="dashboard/submit-feedback" element={<FeedbackForm/>} />
            </>
          )}
          ...
          {user?.accountType === ACCOUNT_TYPE.ADMIN && (
            <>
              ...
              <Route path="dashboard/get-feedback" element={<FeedbackList />} />
              <Route path="/dashboard/grade" element={<CourseWiseGrades />} />
            </>
          )}
          <Route path="dashboard/statistics" element={<AdminStatistics />} />
        </Route>
