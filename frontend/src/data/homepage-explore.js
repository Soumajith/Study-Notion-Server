export const HomePageExplore = [
    ...
    },
    {
            ...
            tag: 'New to Computer Science',
            courses: [
              {
                heading: "Fundamentals of JavaScript",
                description: "Understand the core concepts of JavaScript programming, covering variables, data types, functions, control structures, and DOM manipulation.",
                level: 'Introductory',
                lessonNumber: 6
              },
              {
                heading: "Python Programming Essentials",
                description: "Explore the basics of Python programming, including syntax, data structures, control flow, functions, and file handling.",
                level: 'Introductory',
                lessonNumber: 6
              },
              {
                heading: "Basic SQL Queries",
                description: "Learn the essential concepts of SQL, including database structures, writing SQL queries, and navigating the PostgreSQL database server.",
                level: 'Introductory',
                lessonNumber: 6
              },
            ]
