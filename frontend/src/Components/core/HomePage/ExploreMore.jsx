  ...
  return (
    <div className=''>
      ...
      <div className='text-3xl font-semibold text-center lg:text-4xl'>
        Unlock the 
        <HighlightText text={"Power of Online Course"} />
      </div>
      ...
      px-1 py-1'>
      {
        tabsName.map( (element, index) => {
            return (
                ...
                ${currentTab === element 
                ? "bg-richblack-5 text-black font-medium"
                : "bg-richblack-900 text-richblack-200 " } rounded-full transition-all duration-200 cursor-pointer
