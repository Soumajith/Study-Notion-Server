...
function Home() {
    ...
    const categoryID = "66883326cf02de0c8e3aca16";
  ...
  return (
    <div>
        <div className=' mx-auto relative flex flex-col w-11/12 items-center justify-between text-black '>
            ...
            <div className=' group mt-16 p-1 mx-auto rounded-full bg-white font-bold transition-all duration-200 hover: scale-95 w-fit max-w-maxContent'> { /*changed */}
            ...
            <div className='text-center text-3xl md:text-4xl font-semibold mt-7'>
                One Stop Solution for <HighlightText text={"Course Management"}/>
            </div>
            <div className=' mt-4 w-[90%] text-left md:text-center text-sm md:text-lg font-bold text-richblack-300'>
            With our study by heart, you can learn at your own pace, from anywhere in the world, and get access to a large number of courses, from the expertise, and personalized feedback from instructors. 
            </div>
        ...
        <h2 className='section_heading mb-6 md:text-3xl text-black text-xl'>
        ...
        <div>
            <CodeBlocks 
                ...
                codeblock={`def factorial(n):\nif n == 0:\nreturn 1\nelse:\nreturn n * factorial(n - 1)\nnumber = 5\nresult = factorial(number)\nprint(f"The factorial of {number} is {result}")\nexample = 7\nprint(f"The factorial of {example} is {factorial(example)}")`}
        ...
        <div className='bg-pure-greys-5 text-richblack-700'>
            ...
            <div className='mx-auto w-full  flex flex-col items-center justify-between gap-7'>
